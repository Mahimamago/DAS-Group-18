...
```{r check the large deviance, include=TRUE,out.width='70%', fig.align='center', fig.pos='H', warning=FALSE, fig.cap="\\label{fig:res5} Plots for Pearson and Deviance residuals"}
...
```{r residuals versus fitted values, include=TRUE,out.width='70%', fig.align='center', fig.pos='H', warning=FALSE, fig.cap="\\label{fig:res6} Plots for Residuals and Standardised Residuals against Fitted values"}
...
```{r qq-plot, include=TRUE,out.width='70%', fig.align='center', fig.pos='H', warning=FALSE, fig.cap="\\label{fig:res7} Normal probability plot"}
